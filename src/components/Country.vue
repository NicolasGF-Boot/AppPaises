    ...
    <div class="about-section__text-block">
      ...
      <div class="about-section__text-container">
        ...
        <ul class="about-section__list">
          ...
          <li class="about-section__list-item">
            <span class="font-weight-bold">Habitantes:</span>
            {{
              country.population
                .toString()
                .replace(/\B(?=(\d{3})+(?!\d))/g, ",")
          ...
          <li class="about-section__list-item">
            <span class="font-weight-bold">Región:</span> {{ country.region }}
          </li>
          <li class="about-section__list-item">
            <span class="font-weight-bold">Continente:</span>
            {{ country.subregion }}
          </li>
          <li class="about-section__list-item">
          ...
          <li class="about-section__list-item mt-sm-40">
            <span class="font-weight-bold">Dominio Local:</span>
        ...
        <div class="about-section__borders--container">
          ...
          >
            Paises con los que comparte frontera:
            <v-btn
